...
**Consumer proof: операторска стъпка, предстои** (`/plugin marketplace update` → `/reload-plugins`
→ `/pnp:update`); измереното се вписва тук при relay. Дотогава HARD-007 остава отворен САМО по
тази точка — кодовата половина е затворена и издадена.
