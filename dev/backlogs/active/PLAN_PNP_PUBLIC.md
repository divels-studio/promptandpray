...
POSIX-003 → GATE-001 (всичките затворени с records). Остава: **POSIX-004**, **PS-001**, после
Closeout — всеки чака собствена дума за диспач. RENAME-001 е изваден от плана (операторско решение
2026-09-11) и стои в `dev/backlogs/CANDIDATES.md`.
