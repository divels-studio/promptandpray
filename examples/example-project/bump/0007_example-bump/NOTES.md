...
(`0007_example-bump/0/...`, `0007_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come four times already - most recently
when 0.2.2 shipped the git-verb gate's migration, and this fixture was renamed once more, to
`0007_example-bump`.
