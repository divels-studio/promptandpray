...
(`0013_example-bump/0/...`, `0013_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come ten times already - most recently
when 0.2.8 rendered the Orchestrator role onto every installation and taught the re-render operation
to create an artifact it has no record of, and this fixture was renamed once more, to
`0013_example-bump`.
