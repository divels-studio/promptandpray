...
(`0015_example-bump/0/...`, `0015_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come twelve times already - most recently
when 0.2.10 opened the audit table's `effort` to any value the engine accepts, and this fixture was
renamed once more, to `0015_example-bump`.
