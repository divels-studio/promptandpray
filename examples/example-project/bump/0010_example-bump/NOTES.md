...
(`0010_example-bump/0/...`, `0010_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come seven times already - most recently
when 0.2.5 revoked the standing-word default for a later auditor pass, and this fixture was
renamed once more, to `0010_example-bump`.
