...
(`0012_example-bump/0/...`, `0012_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come nine times already - most recently
when 0.2.7 seeded the transfer surface and gave a release note its `supersedes` list, and this
fixture was renamed once more, to `0012_example-bump`.
