...
(`0014_example-bump/0/...`, `0014_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come eleven times already - most recently
when 0.2.9 gave the two session doors all four preflight documents and turned the
dispatch-waits-for-operator-word seed back into a pointer, and this fixture was renamed once more,
to `0014_example-bump`.
