...
(`0008_example-bump/0/...`, `0008_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come five times already - most recently
when 0.2.3 shipped the PowerShell mirror of the ask ruleset, and this fixture was renamed once
more, to `0008_example-bump`.
