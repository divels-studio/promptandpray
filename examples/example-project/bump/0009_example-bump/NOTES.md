...
(`0009_example-bump/0/...`, `0009_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come six times already - most recently
when 0.2.4 shipped the setup warning about a pre-existing plans directory, and this fixture was
renamed once more, to `0009_example-bump`.
