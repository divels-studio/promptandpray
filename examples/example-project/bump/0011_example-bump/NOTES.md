...
(`0011_example-bump/0/...`, `0011_example-bump/1/...`) in its resolution file. A new operation
...
and a real release names its own migration. That day has come eight times already - most recently
when 0.2.6 regrouped the audit table into four labelled blocks, and this fixture was
renamed once more, to `0011_example-bump`.
